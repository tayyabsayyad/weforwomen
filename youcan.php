  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="images/y1.jpg" style="width:100%;">
      ...
      <div class="item">
        <img src="images/y2.jpg" style="width:100%;">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="images/y3.jpg" style="width:100%;">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="images/y2.jpg" style="width:100%;">
        <div class="carousel-caption">
          <a href="donation_management/get-donation.php" class="btn btn-success btn-lg">
         Get Donation <span class="glyphicon glyphicon-menu-right"></span>  
        </a>
        </div>
      </div>
      ...
      <div class="item">
        <img src="images/y2.jpg" style="width:100%;">
        <div class="carousel-caption">
          <a href="donation_management/give-donation.php" class="btn btn-success btn-lg">
          Give Donation <span class="glyphicon glyphicon-menu-right"></span>  
        </a>
        </div>
      </div>
