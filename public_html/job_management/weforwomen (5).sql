...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2018 at 09:24 AM
...
CREATE TABLE `job_post` (
  ...
  `job_post_org` varchar(255) NOT NULL,
  ...
  `job_post_user_id` int(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
DELIMITER $$
CREATE TRIGGER `trigger_log_job_post_create` AFTER INSERT ON `job_post` FOR EACH ROW insert into log_job_post(actions,ljp_id,ljp_title_new,
ljp_org,ljp_sector_new, ljp_description_new ,ljp_state_new,ljp_city_new,	ljp_skills_new,
ljp_exp_new,ljp_salary_new,ljp_duration_new, ljp_status, ljp_vacancy_new,	ljp_timestamp,	ljp_user_id )                                      VALUES("created", new.job_post_id,new.job_post_title, new.job_post_org, new.job_post_sector, new.job_post_description, new.job_post_city,new.job_post_city, new.job_post_skills, new.job_post_exp, new.job_post_salary, new.job_post_duration, new.job_post_status, new.job_post_vacancy, CURRENT_TIMESTAMP, new.job_post_user_id)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trigger_log_job_post_delete` AFTER DELETE ON `job_post` FOR EACH ROW insert into log_job_post(actions,ljp_id,ljp_title_old, ljp_org, ljp_sector_old, ljp_description_old, ljp_state_old, ljp_city_old ,ljp_skills_old,	ljp_exp_old,	ljp_salary_old,ljp_duration_old,	ljp_status,ljp_vacancy_old,	ljp_timestamp,	ljp_user_id ) VALUES("deleted",old.job_post_id,old.job_post_title,
old.job_post_org, old.job_post_sector, 
old.job_post_description, old.job_post_state, 
old.job_post_city, old.job_post_skills, old.job_post_exp, old.job_post_salary, old.job_post_duration,0, old.job_post_vacancy,CURRENT_TIMESTAMP,old.job_post_user_id)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trigger_log_job_post_update` AFTER UPDATE ON `job_post` FOR EACH ROW insert into log_job_post(actions,ljp_id,ljp_title_old,ljp_title_new, ljp_org, ljp_sector_old,ljp_sector_new,ljp_description_old, ljp_description_new,ljp_state_old,ljp_state_new, ljp_city_old ,ljp_city_new,ljp_skills_old,	ljp_skills_new,ljp_exp_old,	ljp_exp_new,	ljp_salary_old,ljp_salary_new,ljp_duration_old,ljp_duration_new,	ljp_status,ljp_vacancy_old,ljp_vacancy_new,	ljp_timestamp,	ljp_user_id ) VALUES("updated",new.	job_post_id,old.job_post_title,new.job_post_title,
old.job_post_org, old.job_post_sector,new.job_post_sector, 
old.job_post_description,new.job_post_description, old.job_post_state, new.job_post_state,
old.job_post_city,new.job_post_city, old.job_post_skills, new.job_post_skills, old.job_post_exp,new.job_post_exp, old.job_post_salary, new.job_post_salary, old.job_post_duration,new.job_post_duration,new.job_post_status, old.job_post_vacancy,new.job_post_vacancy,CURRENT_TIMESTAMP,old.job_post_user_id)
$$
DELIMITER ;
...
--
ALTER TABLE `job_application`
  MODIFY `job_app_id` int(50) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `job_post`
--
ALTER TABLE `job_post`
  MODIFY `job_post_id` int(50) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `log_job_post`
--
ALTER TABLE `log_job_post`
  MODIFY `ljp_serial_no` int(50) NOT NULL AUTO_INCREMENT;
--
