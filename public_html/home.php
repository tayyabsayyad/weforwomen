...
<body>
	...
	<div class="container-fluid" id="full">
		...
		<div id="full" class="carousel slide" data-ride="carousel">
			...
			<div class="container-fluid" >
				<div class="row" id="bb">
				<button type="button" id="button1" ><p id="blink1">Donate</p></button>
				<button type="button" id="button2" ><p id="blink1">Invest</p></button>
				<button type="button" id="button3" ><p id="blink1">Volunteer</p></button>
				<button type="button" id="button4" ><p id="blink1">Get a Job</p></button>
				<button type="button" id="button5" ><p id="blink1">Post a Job</p></button>
			</div>
		</div>
