...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO postjob(job_title,organisation,job_field, job_desc, job_location, job_skills, experience, budget, payment_type, job_duration, fk_r_id) VALUES ('$job_title', '$organisation','$job_field', '$job_textarea', '$city', '$skills', '$experience' ,'$budget', '$pay_type', $duration,1)";
    ...
    <div class="container-fluid">
        <div class="col-md-8 col-md-offset-2">
            <div class="inner-content">
                ...
                <div class="titles">Organisation Name</div>
                <input class="input-cus" type="text" name="organisation" placeholder="e.g. Yatra Pvt Ltd" required/>
                <br/><br/><br/>
                ...
                <div class = "titles">Upload your Resume (only pdf)</div>
                    <div class="row">
                        <div class="col-sm-8">
