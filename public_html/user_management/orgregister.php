...
<option>Other</option>
						    ...
						    <div class="form-group">
						     ...
						     <div class="form-group">
									...
									<div class="col-sm-4">
		        						<input type="number" class="form-control" id="contact1" placeholder="Contact No 1 " name="contact1">
		      						</div>		
						    </div>
						    ...
						    <div class="form-group">
									...
									<div class="col-sm-4">
		        						<input type="number" class="form-control" id="contact2" placeholder="Contact No 2 " name="contact2">
		      						</div>		
						    </div>
						    ...
						    <div class="form-group">
									...
									<div class="col-sm-4">
		        						<input type="number" class="form-control" id="contact3" placeholder="Contact No 3 " name="contact3">
		      						</div>		
						    </div>
