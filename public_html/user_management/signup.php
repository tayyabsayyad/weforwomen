...
if (isset($_POST['submit'])) {
	...
	if($query_run){
		...
		while( $rows = mysqli_fetch_array($query_run))
		{
			...
			{						
					$sql1 = "INSERT INTO register VALUES('$username','$fllname','$lname','$cuntry','$lcation','$eail','$pin','$pan','$ismentor','$mobile','$uid','$pssword','$gender','$orgname','$orgrep')";
...
<option>Other</option>
							...
							<div class="form-group">
									...
									<div class="col-sm-4">
		        						<input type="number" class="form-control" id="pin" placeholder="Pin-Code" name="pin">
		      						</div>		
						    </div>
						    	...
						    	<div class="form-group">
									...
									<div class="col-sm-4">
		        						<input type="text" class="form-control" id="pan" placeholder="Pan no." name="pan">
		      						</div>		
						    </div>

						    				<div class="form-group">
													<label class="control-label col-sm-4" for="gender" name="ismentor">Are You a Mentor:</label>
													<div class="col-sm-4">
														<select id="mentor" name="ismentor">
							...
							<div class="form-group">
										<label class="control-label col-sm-4" for="lname">Gender</label>
										<div class="col-sm-4">
							...
							<div class="form-group">
										<label class="control-label col-sm-4" for="lname">Organization Representative:</label>
										<div class="col-sm-4">
		        							<input type="number" class="form-control" id="UID" placeholder="Which Organization do you Represent?" name="orgrep" >
		      							</div>
