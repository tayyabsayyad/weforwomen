		...
		while( $rows = mysqli_fetch_array($query_run))
		{
			...
			{					
				...
				if(mysqli_num_rows($query_run2)>0){
					...
					$sql1 = "INSERT INTO register (	user_username,user_fname,user_mname,user_lname,user_country,user_location,user_email,user_pincode,user_pan,user_is_mentor,user_mobile,user_uid,user_password,user_gender,user_organization,user_photo) VALUES('$username','$fllname','$mname','$lname','$cuntry','$lcation','$eail','$pin','$pan','$ismentor','$mobile','$uid','$pssword','$gender','$orgname','abcd')";
        ...
        <div class="container">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form role="form" method="post" action="signup1.php">
                    ...
                    <div class="form-group">
                        <label for="gender" name="ismentor">Do You Want to be a Mentor:</label>
