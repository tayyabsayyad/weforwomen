...
if(isset($_SESSION['current_user_id'])){
    ...
    $loggedinId = $_SESSION['current_user_id'];
    $genderVerification = "select * from register where user_id = ".$loggedinId;
    $resultGender = mysqli_query($con, $genderVerification);
    $rowGender = mysqli_fetch_array($resultGender);
    $gender = $rowGender['user_gender'];
    if(strcmp($gender,'f')){
        header("Location:../index.php");
        exit();
    }
...
<body>
<div>
    <img src="getjobfinal.png" style="width:100%;position:relative;top:-20px"></img>
</div>
<br/><br/>
    <div class="container">
